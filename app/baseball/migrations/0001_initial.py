    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baserunning_stats', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='team_player', to='baseball.playerbaserunningstats')),
                ...
                ('pitching_stats', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='team_player', to='baseball.playerpitchingstats')),
