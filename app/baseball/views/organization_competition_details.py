...
class OrganizationCompetitionDetails (APIView):
    """View, edit, and delete endpoints for the competition model.
    """
    permission_classes = (permissions.IsAuthenticated,)

    def get(self, request: Request, organization_id: str, competition_id: str, format=None) -> Response:
    ...
    def put(self, request: Request, organization_id: str, competition_id: str, format=None) -> Response:
    ...
    def delete(self, request:Request, organization_id: str, competition_id: str, format=None) -> Response:
