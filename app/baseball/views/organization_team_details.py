...
class OrganizationTeamDetails (APIView):
    """View, edit, and delete endpoints for the team model.
    """
    permission_classes = (permissions.IsAuthenticated,)

    def get(self, request: Request, organization_id: str, team_id: str, format=None) -> Response:
    ...
    def put(self, request: Request, organization_id: str, team_id: str, format=None) -> Response:
    ...
    def delete(self, request: Request, organization_id: str, team_id: str, format=None) -> Response:
